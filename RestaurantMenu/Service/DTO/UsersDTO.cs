...
namespace Service.DTO
{
    public class UsersDTO
    {
        ...
        public int CheckNationalCode(string userNation)
        {
            try
            {
                ...
                SqlCommand command = new SqlCommand("select ID From User_Table Where NationalCode = @nationalCode ", con);
                command.Parameters.AddWithValue("@nationalCode", userNation);
                int id = 0;
                try
                {
